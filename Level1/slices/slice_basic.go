...
func main() {
	...
	// quote is an odd-length palindrom, we'd like to print the three characters
	// located at mid-length

	// create a slice that when printed will allow us to print
	// characters going from midlength-1 to midlength+1
